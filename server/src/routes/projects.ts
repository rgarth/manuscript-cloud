...
router.post('/', function(req: Request, res: Response) {
 const handleRequest = async () => {
   try {
     ...
     // Create improved default structure
     const defaultDocs = [
       { title: 'Manuscript', documentType: 'folder', order: 0 },
       { title: 'Notes', documentType: 'folder', order: 1 },
     ];
     ...
     // Find the Notes folder to create nested structure
     const notesFolder = await Document.findOne({ 
       project: project._id, 
       title: 'Notes' 
     });
     ...
     if (notesFolder) {
       const nestedDocs = [
         { title: 'Characters', documentType: 'folder', order: 0, parent: notesFolder._id },
         { title: 'Places', documentType: 'folder', order: 1, parent: notesFolder._id },
         { title: 'Research', documentType: 'folder', order: 2, parent: notesFolder._id },
       ];
     ...
     console.log(`✅ Created project "${name}" with improved default structure`);
